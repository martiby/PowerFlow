...
class Pflow {
    ...
    init_resource() {
        ...
        <style>
            ...
            .pft-col-b { left: 10%; width: 15%; }
            .pft-col-c { left: 30%; width: 70%; }
            ...
            .pft-row [data-id=power]   { font-size: 25px; font-family: var(--font-family); color: var(--color-base); }
            ...
            .pfb-progress[data-bar=in]        { margin-bottom: 14px;}
